...
export default function CognitoRedirect() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center  bg-white  ">
      <div className="bg-gradient-to-br from-blue-50 to-green-50 shadow-lg rounded-2xl p-10 max-w-md w-full text-center rounded-lg m-4">
        <div className="flex flex-col items-center mb-6">
          <Stethoscope className="w-12 h-12 text-green-600 mb-3 mt-4" />
        ...
        <div className="space-y-4">
          <button
            className="w-full/2 m-4 px-6 py-3 bg-green-500 text-white font-medium rounded-lg shadow hover:bg-green-800 transition"
            onClick={() => {
          ...
          <button
            className="w-full/2 m-4 px-6 py-3 bg-blue-500 text-white font-medium rounded-lg shadow hover:bg-blue-800 transition"
            onClick={() => {
              window.location.href =
